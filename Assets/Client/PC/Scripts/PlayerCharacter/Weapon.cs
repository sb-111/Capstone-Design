...
public class Weapon : MonoBehaviourPun
{
    ...
    public void ShieldEffectInstance()
    {
        ...
        if (!isShield)
        {
            ...
            nEffectPrefab = PhotonNetwork.Instantiate(shieldEffectPrefab.name, transform.position + new Vector3(0.0f,0.0f,0.0f),transform.rotation* reverseRoation);
    ...
    public void ShieldEffectOut()
    {
        ...
        {
            PhotonNetwork.Destroy(nEffectPrefab);
            nEffectPrefab = null;
            isShield = false;
        }
    }
